...
- Contains theme, accent color, crossfade, gapless, replay gain, EQ, playback speed/pitch, etc.
...
- Handles play/pause, seek, shuffle, repeat, crossfade (volume ramping), playback speed/pitch.
